...
LUXIA Cloud Vector Embedding API, cosine similarity, HDBSCAN 군집화, UMAP, 구역 분리 레이아웃을 사용해 시민 의견 100건을 2D 의견 지도로 시각화하는 로컬 풀스택 프로토타입입니다.
...
10. React + Plotly.js 프론트엔드에서 의견 지도를 시각화합니다.
